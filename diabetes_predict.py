...
def app(diabetes_df):
    ...
    bp = st.slider("Blood_Pressure",float(diabetes_df['Blood_Pressure'].min()), float(diabetes_df['Blood_Pressure'].max()))
    ...
    pedigree = st.slider("Pidegree",float(diabetes_df['Pedigree_Function'].min()), float(diabetes_df['Pedigree_Function'].max()))
